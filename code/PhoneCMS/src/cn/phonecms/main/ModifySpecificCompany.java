...
public class ModifySpecificCompany extends Activity implements OnClickListener,OnUploadProcessListener
{
  ...
  private int productImage;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        backBtn.setOnClickListener(new OnClickListener() { 
          ...
          myIntent = new Intent(ModifySpecificCompany.this, ViewSpecificProduct.class);
        ...
        modifyBtn.setOnClickListener(new OnClickListener() { 
          public void onClick(View v) { 
           ...
           mineIntent = new Intent(ModifySpecificCompany.this, ManageProduct.class);
